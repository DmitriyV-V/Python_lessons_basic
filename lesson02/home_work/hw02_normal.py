...
dateAnswer = date_f[0] + ' ' + date_f[1] + ' ' + date_f[2] + ' года'
...
print("Неповторяющиеся элементы: ",  set(myList))
...
print("Элементы исходного списка, которые не имеют повторений: ", new_list)
